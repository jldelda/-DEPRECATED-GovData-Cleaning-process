...
colnames(updates2018)[1] = 'indicator'
updates2018$Indicator_Name = updates2018$question

drop2 = c('X', 'encoded', 'indicator')
...
setdiff(unique(GovData360$indicator), unique(GovData360IND$indicator))
setdiff(unique(GovData360IND$indicator), unique(GovData360$indicator))
