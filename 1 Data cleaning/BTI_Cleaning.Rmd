...
```{r}
Hierarchy = Hierarchy %>% select('Indicator', 'Value.Type.Slug','Value.Type.Descriptor', 'Units', 'Rank.1', "Category.1.2", "Category.1.3", "Category.1.4", "Category.1.5", "Rank.2", "Category.2.1", "Category.2.2", "Category.2.3", "Category.2.4", "Category.2.5", "Rank.3","Category.3.1", "Category.3.2", "Category.3.3", "Category.3.4")
